...
@Component({
  selector: 'app-pharmacy-sales-order-list',
  templateUrl: './pharmacy-sales-order-list.component.html',
  styleUrls: ['./pharmacy-sales-order-list.component.scss'],
  standalone : true,
  imports : [
    CommonModule,
    FormsModule,
...
export class PharmacySalesOrderListComponent {
  pharmacistId : any
