...
@Component({
  selector: 'app-nurse-general-examination-history',
  templateUrl: './nurse-general-examination-history.component.html',
  styleUrls: ['./nurse-general-examination-history.component.scss'],
  standalone : true,
  imports : [
    CommonModule,
    FormsModule,
...
export class NurseGeneralExaminationHistoryComponent {
