...
@Component({
  selector: 'app-nurse-prescription-history',
  templateUrl: './nurse-prescription-history.component.html',
  styleUrls: ['./nurse-prescription-history.component.scss'],
  standalone : true,
  imports : [
    CommonModule,
    FormsModule,
...
export class NursePrescriptionHistoryComponent {
