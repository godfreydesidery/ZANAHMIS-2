...
@Component({
  selector: 'app-nurse-final-diagnosis-history',
  templateUrl: './nurse-final-diagnosis-history.component.html',
  styleUrls: ['./nurse-final-diagnosis-history.component.scss'],
  standalone : true,
  imports : [
    CommonModule,
    FormsModule,
...
export class NurseFinalDiagnosisHistoryComponent {
  ...
  async getFinalDiagnosisHistory(){
    ...
    .then(
      data => {
        this.finalDiagnosises = data!.reverse()
        console.log(data)
