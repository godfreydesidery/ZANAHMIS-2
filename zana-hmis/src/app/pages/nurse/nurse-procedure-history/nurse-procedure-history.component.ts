...
@Component({
  selector: 'app-nurse-procedure-history',
  templateUrl: './nurse-procedure-history.component.html',
  styleUrls: ['./nurse-procedure-history.component.scss'],
  standalone : true,
  imports : [
    CommonModule,
    FormsModule,
...
export class NurseProcedureHistoryComponent {
