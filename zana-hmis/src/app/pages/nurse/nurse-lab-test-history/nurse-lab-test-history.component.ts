...
@Component({
  selector: 'app-nurse-lab-test-history',
  templateUrl: './nurse-lab-test-history.component.html',
  styleUrls: ['./nurse-lab-test-history.component.scss'],
  standalone : true,
  imports : [
    CommonModule,
    FormsModule,
...
export class NurseLabTestHistoryComponent {
