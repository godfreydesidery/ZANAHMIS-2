...
@Component({
  selector: 'app-nurse-clinical-note-history',
  templateUrl: './nurse-clinical-note-history.component.html',
  styleUrls: ['./nurse-clinical-note-history.component.scss'],
  standalone : true,
  imports : [
    CommonModule,
    FormsModule,
...
export class NurseClinicalNoteHistoryComponent {
  ...
  async getClinicalNoteHistory(){
    ...
    .then(
      data => {
        this.clinicalNotes = data!.reverse()
        console.log(data)
